        ...
        <div className="footer__content">
          ...
          <div className="footer__contact">
            ...
            <div className="footer__socials">
              <ul className="footer__socials-bar">
                <li className="footer__socials-item">
                  <a className="footer__socials-link footer__socials-fb" href="https://www.facebook.com/" aria-label="Facebook">
                    <svg className="footer__socials-icon footer__socials-icon--fb" width="9" height="16">
                ...
                <li className="footer__socials-item">
                  <a className="footer__socials-link footer__socials-insta" href="https://www.instagram.com/">
                    <svg className="footer__socials-icon footer__socials-icon--insta" width="16" height="16">
                ...
                <li className="footer__socials-item">
                  <a className="footer__socials-link footer__socials-tw" href="https://twitter.com/">
                    <svg className="footer__socials-icon footer__socials-icon--tw" width="16" height="16">
                ...
                <li className="footer__socials-item">
                  <a className="footer__socials-link footer__socials-youtube" href="https://www.youtube.com/">
                    <svg className="footer__socials-icon footer__socials-icon--youtube" width="16" height="16">
